...
CREATE TABLE IF NOT EXISTS 'Items' (
  ...
  'name' varchar(20) NOT NULL,          -- actual display name, eg. 'Iron Sword'
  'description' varchar(50) NOT NULL,   -- flavortext
  'value' INTEGER NOT NULL,           -- value in gold
  ...
  'slot' varchar(10) DEFAULT NULL,    -- 'WEAPON' / 'ARMOR' / 'ACCESSORY'
  'type' varchar(10) DEFAULT NULL,    -- 'SWORD' / 'STAFF' / 'LIGHT' / 'HEAVY' / and so on
...
CREATE TABLE IF NOT EXISTS 'Skills' (
  ...
  'name' varchar(20) NOT NULL,          -- actual display name, eg. 'Shield Bash'
  'description' varchar(50) NOT NULL,   -- flavortext
...
CREATE TABLE IF NOT EXISTS 'Classes' (
  ...
  'name' varchar(20) NOT NULL,          -- actual display name, eg. 'Warrior'
  'description' varchar(50) NOT NULL,   -- flavortext
  -- starting stats
  'hp' INTEGER NOT NULL,
  'mp' INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS 'Scores' (
  ...
  'name' varchar(30) NOT NULL, -- character name
