...
class Classes extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['handle', 'class_name', 'skill_1', 'skill_5', 'skill_10', 'skill_15', 'skill_20', 'weapon', 'armor', 'accessory', 'item1', 'item2', 'item3', 'item4'], 'string', 'max' => 20],
            [['class_description'], 'string', 'max' => 50],
